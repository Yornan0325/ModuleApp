                        ...
                        <div className="px-6 pt-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <p className="text-bold md:text2xl text-base pl-3 text-gray-800">ConEpp</p>
                                </div>
                                ...
                                <a>
                                    <li className="text-white pt-8">
                                        <div className="flex items-center">
                                            ...
                                            <p className="text-indigo-500 ml-3 text-lg">Home</p>
                                        </div>
                                    </li>
                                </a>
                                    ...
                                    <li className="text-gray-800 pt-8">
                                        <div className="flex items-center">
                                            <div className="flex items-center">
                                                ...
                                                <p className="text-gray-800 ml-3 text-lg">Acceso</p>
                                            </div>
                                        ...
                                        {deliverables ? (
                                            <div>
                                                <ul className="my-3">
                                                    <li className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6">Iniciar sesión</li>
                                                    <li className="text-sm text-gray-800 hover:text-indigo-500 py-2 px-6">Cerrar sesión</li>
                                                </ul>
                                            </div>
                                        ) : (
                                            ""
                            ...
                            <div className="border-t border-gray-300">
                                <div className="w-full flex items-center justify-between px-6 pt-1">
                                    <div className="flex items-center">
                                        ...
                                        <p className=" text-gray-800 text-base leading-4 ml-2">YG</p>
                                    </div>
                                    <ul className="flex">
